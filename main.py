...
async def main():
    # configure your websocket and http server here
    WEBSOCKET_URI = "ws://127.0.0.1:5001/"
    HTTP_URI = "http://127.0.0.1:5002/"

    # target group for message detection
    TARGET_GROUP = 0
    ...
    async with websockets.connect(WEBSOCKET_URI) as ws:
        while True:
            ...
            if gid == TARGET_GROUP:
                print("message from target group:" + str(gid))
                ...
                print("not from target group, skipping")
